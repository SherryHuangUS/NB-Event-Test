...
class BootStrap {
    ...
    def generateEvents() {
        ...
        Event event11 = new Event(date: sdf.parse("2014-03-28T13:00:00Z"), user: User.get(1), type: EventType.ENTER).save()
        Event event12 = new Event(date: sdf.parse("2014-03-28T13:01:00Z"), user: User.get(2), type: EventType.ENTER).save()
        Event event13 = new Event(date: sdf.parse("2014-03-28T13:02:00Z"), user: User.get(1), type: EventType.COMMENT, message: "Hi there!").save()
        Event event14 = new Event(date: sdf.parse("2014-03-28T13:03:00Z"), user: User.get(2), type: EventType.COMMENT, message: "Hello!").save()
        Event event15 = new Event(date: sdf.parse("2014-03-28T14:00:00Z"), user: User.get(1), type: EventType.HIGHFIVE, otherUser: User.get(2)).save()
        Event event16 = new Event(date: sdf.parse("2014-03-28T14:01:00Z"), user: User.get(1), type: EventType.LEAVE).save()
        Event event17 = new Event(date: sdf.parse("2014-03-28T14:01:00Z"), user: User.get(2), type: EventType.LEAVE).save()
